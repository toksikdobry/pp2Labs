...
while True:
    ...
    for event in pygame.event.get():
        ...
        if mode == 4:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                screen.blit(screen2, (0, 0))
                pygame.draw.polygon(screen, color, [((currentX - prevX)/2 + prevX, prevY), (currentX, (currentY - prevY)/2 + prevY), ((currentX - prevX)/2 + prevX, currentY), (prevX, (currentY - prevY)/2 + prevY)], radius)        
        ...
        if mode == 5:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                screen.blit(screen2, (0, 0))
                pygame.draw.polygon(screen, color, [(prevX, prevY), (currentX, currentY), (prevX, currentY)], radius)        
        ...
        if mode == 5:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                screen.blit(screen2, (0, 0))
                pygame.draw.polygon(screen, color, [(prevX, currentY), (currentX, currentY), (prevX + (currentX - prevX)/2, prevY)], radius)        
        ...
        if mode == 6:
            ...
            if mouse_down and prevX != -1 and prevY != -1 and currentX != -1 and currentY != -1:
                screen.blit(screen2, (0, 0))
                m = min(currentX - prevX, currentY - prevY)
                pygame.draw.rect(screen, color, pygame.Rect(prevX, prevY, m, m), radius)
